...
import { CommitMessageRequest, CommitMessageResult, MessageType } from "../types/core"
					...
					const integration: ICommitMessageIntegration = {
						...
						handleResult: async (result: CommitMessageResult) => {
							...
							if (result.error) {
								...
								await method(t("common:commitMessage.generationFailed", { errorMessage: result.error }))
							}
						},
					}
